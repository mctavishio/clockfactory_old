...
const rawsoundfileweightseeds = [
	{gain:0.5,list:[ ["clarinet1",4,toneweights[9]], ["clarinetnotes_a",2,toneweights[9]], ["clarinetnotes_e",2,toneweights[9]], ["clarinetnotes_f",1,toneweights[9]], ["clarinetnotes_g",1,toneweights[9]], ["clarinetnotes_b",1,toneweights[9]], ["clarinetnotes_i",1,toneweights[9]] ]},
	{gain:0.3,list:[ ["magsSessionClips_3b",1,toneweights[14]], ["magsSessionClips_1",2,toneweights[2]],["mctbreathing0",1,toneweights[2]] ]},
	{gain:0.2,list:[ ["icebowedvibes1",1,toneweights[9]],["mctbreathing0",1,toneweights[2]] ]},
];
const rawsoundfiledata_subset = rawsoundfileweightseeds.filter(x=>x.clips).reduce( (acc,rawsoundfiles) => {
	...
	rawsoundfiles.forEach( rawsoundfile => { 
		if(!counted.includes(rawsoundfile[0])) {
			acc.push(rawsoundfiledata.filter(f => f.id===rawsoundfile[0]));
		}
	});
	return acc;
}, []);
