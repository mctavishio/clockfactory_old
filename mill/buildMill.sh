...
# sed "s/notext/withtext/" film.html > filmwithtext.html
# prince -s css/print.css filmwithtext.html -o filmwithtext.pdf
...
echo "|:|"
cd ../..
echo gsutil -m cp -r data/mill$dt gs://soundfactory/
...
echo "open data/mill$dt/film_withtext.mp4"
echo "|:|"
